...
class $AssetsLottiesGen {
  ...
  String get love => 'assets/lotties/love.json';

  /// List of all assets
  List<String> get values => [love];
}

class $AssetsSoundGen {
  const $AssetsSoundGen();

  /// File path: assets/sound/open_door.mp3
  String get openDoor => 'assets/sound/open_door.mp3';

  /// List of all assets
  List<String> get values => [openDoor];
}
